...
juce::AudioProcessorValueTreeState::ParameterLayout createParameterLayout()
{
    ...
    result.add(std::make_unique<Parameter>(
        ...
        "Source Link",
        "",
        juce::NormalisableRange<float>(0.0f, static_cast<float>(POSITION_SOURCE_LINK_STRINGS.size() - 1), 1.0f),
        0.0f,
        nullptr,
        nullptr,
        false,
    ...
    result.add(std::make_unique<Parameter>(
        ...
        "Position Trajectory",
        "",
        juce::NormalisableRange<float>{ 0.0f, narrow<float>(POSITION_TRAJECTORY_TYPE_STRINGS.size() - 1), 1.0f },
        0.0f,
        nullptr,
        nullptr,
        false,
    ...
    result.add(std::make_unique<Parameter>(
        ...
        "",
        juce::NormalisableRange<float>{ 0.0f, narrow<float>(ELEVATION_TRAJECTORY_TYPE_STRINGS.size() - 1), 1.0f },
        0.0f,
        nullptr,
        nullptr,
        false,
